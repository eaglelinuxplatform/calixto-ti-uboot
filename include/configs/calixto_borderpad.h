...
#ifndef __CONFIG_AM335X_BORDERPAD_H
#define __CONFIG_AM335X_BORDERPAD_H

#include <configs/ti_am335x_common.h>

#undef  CONFIG_PMIC_TPS65910
...
#define CONFIG_SYS_LDSCRIPT		"board/calixto/calixto_borderpad/u-boot.lds"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootdir=/boot\0" \
	"bootfile=zImage\0" \
	"fdtfile=am335x-calixto-optima.dtb\0" \
	"moduleconfig=csevm\0" \
        "fdtcustomfile=am335x-calixto-optima.dtb\0" \
	...
	"bootcmd_mmc=echo Booting from SD Card ...; "\
		...
		"setenv mmcroot /dev/mmcblk0p2;" \
        	"run mmcbootos;\0" \
	"bootcmd_uart=echo Booting from UART ...; "\
		"loady 0x82000000; " \
		"sf probe 0; " \
		"sf erase 0x0 0x80000; " \
		"sf write 0x82000000 0x0 ${filesize}; " \
		"loady 0x82000000; " \
		"sf write 0x82000000 0x20000 ${filesize};\0" \
		"setenv boot_targets mmc;" \
		"saveenv;\0" \
	"bootcmd_flasher=echo Booting for flashing ...; "\
		"setenv autoload no; " \
		"dhcp; " \
	...
	"bootcmd_net=echo Booting from network ...; " \
		"setenv autoload no; " \
		"dhcp; " \
		"tftp ${loadaddr} ${bootfile}; " \
		"tftp ${fdtaddr} ${fdtfile}; " \
